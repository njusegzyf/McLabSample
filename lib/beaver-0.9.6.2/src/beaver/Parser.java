...
////////////////////////////////////////////////////////////////////////////////
// Modified by Andrew Casey (McGill University) 20090210
// Parser$TokenStream.insert(Symbol, Symbol) was causing an
...
public abstract class Parser
{
	...
	private class TokenStream
	{
		...
		{
		    if(n_written + 2 > buffer.length) {
		        Symbol[] tmp = new Symbol[n_written + 2];
		        System.arraycopy(buffer, 0, tmp, 2, n_written);
		        buffer = tmp;
		        n_marked += 2;
		    } else {
